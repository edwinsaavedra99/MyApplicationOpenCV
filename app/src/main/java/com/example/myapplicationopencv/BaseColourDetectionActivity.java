...
public class BaseColourDetectionActivity extends AppCompatActivity implements View.OnTouchListener, CameraBridgeViewBase.CvCameraViewListener2 {
        ...
        public void onManagerConnected(int status) throws IOException {
            switch (status) {
                case LoaderCallbackInterface.SUCCESS:
                {
                    ...
                    mOpenCvCameraView.setOnTouchListener(BaseColourDetectionActivity.this);
                } break;
                default:
                {
    ...
    public BaseColourDetectionActivity () {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_base_colour_detection);
